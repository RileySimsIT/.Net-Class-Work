...
namespace Riley_eCommerce
{
    public partial class Details : System.Web.UI.Page
    {
        ...
        {
            //MessageBox.Show(this, "Processing Order");
            ...
            for (int i = 0; i < productArray.Length; i++)
            {
                ...
                try
                {
                    ...
                    sqlString = "SELECT QOH FROM Products WHERE ProductID = @ProdID";
                ...
                sqlString = "UPDATE Products SET QOH = @QtyOnHand WHERE ProductID = @ProdID";
                ...
                try
                {
                    ...
                    {
                        MessageBox.Show(this, "Your Transaction was incomplete, Not enough products");
                        
                        dbTrans.Rollback();
                        Log.LogMessage("MessageStream", "PayForOrder 4.0 "+"Not enough products");
                        DisposeResources(ref sqlDataAdapter, ref ds, ref connectFill, ref connectCmd, ref cmd, ref scmd);
                        return;
                    }
                }
